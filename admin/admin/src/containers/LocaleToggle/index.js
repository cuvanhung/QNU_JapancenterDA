...
export class LocaleToggle extends React.Component { // eslint-disable-line
  ...
  getFlagUrl = (locale) => {
    switch (locale) {
      ...
      case 'ar':
        return 'https://lh5.googleusercontent.com/gyhlq0KVH8aUhCeSkiN3eFxqCIeIbM5SQ3dXYzYbZJpXvvvt8U4zrQLrlU0oeAfg0HyDgp8W1AqdaD2e0_hK=w1920-h919-rw';
      case 'ko':
      ...
      <div className={styles.localeToggle}>
        <ButtonDropdown isOpen={this.state.isOpen} toggle={this.toggle}>
          <DropdownToggle className={styles.localeDropdownContent}>
            <span>{locale}</span><img src={this.getFlagUrl(locale)} alt={locale} />
          </DropdownToggle>
